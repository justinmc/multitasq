...
Multitasq.Modal=Backbone.View.extend({template:_.template($("script.template-modal").html()),parentSelector:".modal-view",task:null,events:{"click .modal-background":"close","click .close":"close","keyup body":"keyup"},initialize:function(t){this.task=t.task,this.callback=t.callback;var e=this;this.task.bind("change",function(){e.render()}),this.keyupBound=this.keyup.bind(this),$("body").on("keyup",this.keyupBound),this.render()},render:function(){return this.$el=$(this.template({title:this.task.get("title"),description:this.task.get("title"),created:this.task.getCreatedHuman(),updated:this.task.getUpdatedHuman()})),$(this.parentSelector).html(this.$el),this.editTitle=new Multitasq.EditableInput({task:this.task,attribute:"title",parentSelector:".editable-input.title"}),this.editDescription=new Multitasq.EditableInput({task:this.task,attribute:"description",parentSelector:".editable-input.description","long":!0}),this.delegateEvents(),this},show:function(){},close:function(){$("body").off("keyup",this.keyupBound),this.remove(),this.callback()},keyup:function(t){(27===t.which||13===t.which)&&this.close()}});
Multitasq.EditableInput=Backbone.View.extend({template:_.template($("script.template-editable-input").html()),parentSelector:null,defaultValue:"Click to edit",editing:!1,events:{"click .editable":"edit","click .save":"save","click .cancel":"close","keypress .edit":"inputKeypress","keyup .edit":"inputKeyup"},initialize:function(t){this.task=t.task,this.attribute=t.attribute,this.parentSelector=t.parentSelector,this.callback=t.callback,t.long&&(this.template=_.template($("script.template-editable-input-long").html())),this.render()},render:function(){var t=this.template({value:this.task.get(this.attribute),defaultValue:this.defaultValue,editing:this.editing});return this.$el=$(this.parentSelector).html(t),this.delegateEvents(),this},edit:function(){this.editing=!0,this.render(),this.$el.find(".edit").get(0).select()},close:function(){this.editing=!1,this.render()},save:function(){var t={};t[this.attribute]=this.$el.find(".edit").val(),this.task.save(t),this.close()},inputKeypress:function(t){13===t.which&&this.save()},inputKeyup:function(t){27===t.which&&this.close()}});
Multitasq.Router=Backbone.Router.extend({routes:{"":"main",help:"help","task/:id":"task","*path":"main"},initialize:function(t){this.app=t},main:function(){this.app.helpHide()},help:function(){this.app.helpShow()},task:function(t){this.app.sandbox.editTask(t)}});
$(function(){new Multitasq});